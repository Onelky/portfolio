...
export const HEADER_PARAGRAPH: string =
  "Hello! My name is Onelky and I like creating things \
...
export const myTasks: Project = {
  ...
  description:
    'Web application that facilitates the management of pendant tasks and their classification.' +
...
export const skillCards = [
  {
    title: 'Front-end',
    icons: [html, css, javascript, typescript, react, redux, nextJs, angular]
  },
  {
    title: 'Back-end',
    icons: [nodeJs, expressJs, cSharp, python, mongo, mySql, sqlServer]
  },
  {
    title: 'Other tools',
    icons: [docker, git, graphQL, figma, jest, cypress]
  }
]
